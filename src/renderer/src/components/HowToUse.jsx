...
import { Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, useDisclosure, Button, IconButton, Text } from "@chakra-ui/react"
			...
			<Modal isOpen={isOpen} onClose={onClose}>
				...
				<ModalContent>
					...
					<ModalBody overflowY="auto" maxH="300px">
						...
						<Text mb={4}>Pressing the Spacebar or Pressing the "0" key (Digit0 or Numpad0) will remove a flashing rock.</Text>

						<Text fontWeight="bold" mb={2}>
							Switching Hammer (Toggle A/B):
						</Text>
						<Text>Press the "5" key (Digit5 or Numpad5) key to toggle between Team A and Team B having the hammer.</Text>
