		...
		<HStack align="start" spacing={2}>
			{teamScores.map((scores, index) => (
				<VStack key={index} spacing={3} alignItems="center">
					...
					<Box>
						<Select value={scores.score1} onChange={e => handleScoreChange(index, "score1", e.target.value)}>
					...
					<Box>
						<Select value={scores.score2} onChange={e => handleScoreChange(index, "score2", e.target.value)}>
							{" "}
							<option value="0">0 </option>
							<option value="1">1 </option>
							<option value="2">2 </option>
