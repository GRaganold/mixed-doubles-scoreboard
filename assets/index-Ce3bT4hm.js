...
function getCss(options) {
  ...
  const css2 = (stylesOrFn, nested = false) => {
    ...
    for (let key in styles2) {
      ...
      rawValue = config2?.processResult ? css2(rawValue, true) : rawValue;
      const configProperty = runIfFn$1(config2?.property, theme2);
...
function createResolver(theme2) {
  ...
  return function resolver(config2, prop, value, props) {
    ...
    for (let i = 0; i < len; i++) {
      ...
      const styles2 = runIfFn$1(config2[prop]?.[normalized[i]], props);
      if (!styles2)
        continue;
      if (isMultipart) {
...
const useSafeLayoutEffect = isBrowser$3() ? reactExports.useLayoutEffect : reactExports.useEffect;
...
class JSAnimation extends WithPromise {
  ...
  initAnimation() {
    ...
    if (generatorFactory !== keyframes && typeof keyframes$12[0] !== "number") {
      this.mixKeyframes = pipe$1(percentToProgress, mix(keyframes$12[0], keyframes$12[1]));
      keyframes$12 = [0, 100];
    }
...
function renderHTML(element, { style, vars: vars2 }, styleProp, projection) {
  ...
  for (key in vars2) {
    elementStyle.setProperty(key, vars2[key]);
  }
}
...
function buildSVGPath(attrs, length2, spacing2 = 1, offset = 0, useDashCase = true) {
  ...
  attrs[keys2.array] = `${length2} ${spacing2}`;
}
...
function buildSVGAttrs(state2, {
  ...
  ...latest
}, isSVGTag2, transformTemplate2, styleProp) {
...
function createProjectionNode$1({ attachResizeListener, defaultParent, measureScroll, checkIsScrollRoot, resetTransform }) {
  return class ProjectionNode {
    ...
    applyProjectionStyles(targetStyle, styleProp) {
      ...
      if (transformTemplate2) {
        transform2 = transformTemplate2(valuesToRender, transform2);
      }
...
function PopChild({ children, isPresent: isPresent2, anchorX, anchorY, root }) {
  ...
  return jsxRuntimeExports.jsx(PopChildMeasure, { isPresent: isPresent2, childRef: ref, sizeRef: size2, children: reactExports.cloneElement(children, { ref: composedRef }) });
}
const PresenceChild = ({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode: mode2, anchorX, anchorY, root }) => {
  ...
  if (mode2 === "popLayout") {
    children = jsxRuntimeExports.jsx(PopChild, { isPresent: isPresent2, anchorX, anchorY, root, children });
  }
...
const AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode: mode2 = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: renderedChildren.map((child) => {
    ...
    return jsxRuntimeExports.jsx(PresenceChild, { isPresent: isPresent2, initial: !isInitialRender.current || initial ? void 0 : false, custom, presenceAffectsLayout, mode: mode2, root, onExitComplete: isPresent2 ? void 0 : onExit, anchorX, anchorY, children: child }, key);
  }) });
};
...
const colorStyles = {
  red: {
    bgGradient: "linear(to bottom, #ff0000 50%, #c20000 60%, #8a0000 100%)",
    color: `#FFFFFF`,
    bg: "#c20000"
  },
  yellow: {
    bgGradient: "linear(to bottom, #ffff00 50%, #c2c200 60%, #8a8a00 100%)",
    color: `#000`,
    bg: "#ffff00"
  },
  darkBlue: {
    bgGradient: "linear(to bottom, #00008b 50%, #000075 60%, #00005e 100%)",
    color: `#FFFFFF`,
    bg: "#00008b"
  },
  blue: {
    bgGradient: "linear(to bottom, #0000ff 50%, #0000c2 60%, #00008a 100%)",
    color: `#FFFFFF`,
    bg: "#0000ff"
  },
  black: {
    bgGradient: "linear(to bottom, #000000 50%, #1c1c1c 60%, #383838 100%)",
    color: `#FFFFFF`,
    bg: "#000000"
  },
  green: {
    bgGradient: `linear(to-t, #006600 50%, #008000 60%, #006600 100%)`,
    color: `#FFFFFF`,
    bg: "#006600"
  }
};
...
const getColorStyles$2 = (color2) => {
  return colorStyles[color2] || {
    color: "#d1d2d3",
...
function ControlPanel({
  ...
  const teamAStyles = getColorStyles$2(teamAColor);
  const teamBStyles = getColorStyles$2(teamBColor);
  ...
  const ButtonTeamBWithHammer = ({
    teamBRockCountState: teamBRockCountState2,
    teamARockCountState: teamARockCountState2,
    handleDecreaseARock: handleDecreaseARock2,
    handleDecreaseBRock: handleDecreaseBRock2,
    handleIncreaseEnd: handleIncreaseEnd2
  }) => {
    ...
    const totalRocks = teamBRockCountState2 + teamARockCountState2;
    const handleTeamBWithHammer = () => {
      if (teamBRockCountState2 !== 0 && teamARockCountState2 !== 0 && totalRocks % 2 === 0) {
        handleDecreaseARock2();
      } else if (teamBRockCountState2 === 0 && teamARockCountState2 === 0) {
        handleIncreaseEnd2();
      } else {
        handleDecreaseBRock2();
      }
    };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(HStack, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Text,
        {
          ...
          textOverflow: "ellipsis",
          textAlign: "end",
          children: teamBName === "" ? "Team B has hammer" : teamBName + " has hammer"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          _hover: hoverStyle,
          bg: teamBRockCountState2 !== 0 && teamARockCountState2 !== 0 && totalRocks % 2 === 0 ? teamAStyles.bg : teamBStyles.bg,
          color: teamBRockCountState2 !== 0 && teamARockCountState2 !== 0 && totalRocks % 2 === 0 ? teamAStyles.color : teamBStyles.color,
          children: "-"
        }
      )
    ] });
  ...
  const ButtonTeamAWithHammer = ({
    ...
    const totalRocks = teamARockCountState2 + teamBRockCountState2;
    const handleTeamAWithHammer = () => {
      if (teamARockCountState2 !== 0 && teamBRockCountState2 !== 0 && totalRocks % 2 === 0) {
        handleDecreaseBRock2();
      } else if (teamBRockCountState2 === 0 && teamARockCountState2 === 0) {
        handleIncreaseEnd2();
      } else {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(HStack, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Text,
        {
          ...
          textOverflow: "ellipsis",
          textAlign: "end",
          children: teamAName === "" ? "Team A has hammer" : teamAName + " has hammer"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          bg: teamARockCountState2 !== 0 && teamBRockCountState2 !== 0 && totalRocks % 2 === 0 ? teamBStyles.bg : teamAStyles.bg,
          _hover: hoverStyle,
          color: teamARockCountState2 !== 0 && teamBRockCountState2 !== 0 && totalRocks % 2 === 0 ? teamBStyles.color : teamAStyles.color,
  ...
  const handleScoreChange = (endIndex, teamKey, newScore, end2) => {
  ...
  const renderEndScores = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(HStack, { align: "start", spacing: 1, fontSize: "sm", children: teamScores.map((scores, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(VStack, { spacing: 4, alignItems: "center", gap: "5px", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { fontWeight: "bold", children: `End ${index + 1}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          ...
          borderRadius: 5,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "0", children: "0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "1", children: "1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "2", children: "2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "3", children: "3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "4", children: "4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "5", children: "5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "6", children: "6" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "7", children: "7" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "8", children: "8" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleA, value: "X", children: "X" })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          ...
          borderRadius: 5,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "0", children: "0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "1", children: "1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "2", children: "2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "3", children: "3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "4", children: "4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "5", children: "5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "6", children: "6" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "7", children: "7" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "8", children: "8" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { style: optionStyleB, value: "X", children: "X" })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { background: "#00ff00", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { fontSize: "sm", pr: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { display: "flex", justify: "start", bg: "#E8E8E8", rounded: "md", p: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(VStack, { color: "black", m: 1, w: "650px", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            ...
            onChange: (e) => {
              ...
              setTeamARockCountState(value);
              setTeamBRockCountState(value);
            },
            bg: "white",
            w: "250px",
            _focus: { bg: "white" },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", disabled: true, children: "- stages of competition -" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Round Robin", children: "Round Robin" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Playoff", children: "Playoff" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Quarter Final", children: "Quarter Final" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Semi Final", children: "Semi Final" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Final", children: "Final" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Tiebreaker", children: "Tiebreaker" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        VStack,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { direction: "row", justify: "space-around", align: "center", w: "full", spacing: 5, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  value: teamAColor || "",
                  ...
                  borderRadius: 5,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", disabled: true, children: "--- Select a color ---" }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "darkBlue", children: "dark blue" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { children: " Rocks : " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  bg: teamAStyles.bg,
    ...
    renderEndScores(),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { direction: "row", justify: "center", gap: 5, w: "100%", align: "center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(HStack, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Scoreboard type:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            w: "100px",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Full" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "2", children: "Names" })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(HStack, { gap: 5, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { children: " End :" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            color: nonTeamButtons.color,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { direction: "row", justify: "space-evenly", w: "100%", align: "center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          w: "250px",
          ...
          fontSize: "xs",
          children: [
            hammerState === "A" ? teamAName || "Team A" : teamBName || "Team B",
            " has hammer"
          ]
        }
      ),
      hammerState === "A" ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const CircleIcon$1 = (props) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Icon, { viewBox: "0 0 200 200", ...props, children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "black-gray-black", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", style: { stopColor: "#303030", stopOpacity: 1 } }),
...
function TeamARocks({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Flex,
    {
      ...
      pl: "20px",
      children: hammerState === "A" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        WithHammerTeamA,
        {
          teamBRockCountState,
          teamARockCountState,
...
const CircleIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Icon, { viewBox: "0 0 200 200", ...props, children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "black-gray-black", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", style: { stopColor: "#303030", stopOpacity: 1 } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "50%", style: { stopColor: "#707070", stopOpacity: 1 } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", style: { stopColor: "#909090", stopOpacity: 1 } })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Flex,
      {
        ...
        pl: "20px",
        children: hammerState === "B" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          WithHammerTeamB,
          {
            teamBRockCountState,
            teamBColor,
...
const HammerIcon = ({ flip, color: color2, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { viewBox: "0 0 576 512", transform: flip ? "scale(-1, 1)" : "", ...props, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
  "path",
  {
    d: "m571.31 193.94-22.63-22.63c-6.25-6.25-16.38-6.25-22.63 0l-11.31 11.31-28.9-28.9c5.63-21.31.36-44.9-16.35-61.61l-45.25-45.25c-62.48-62.48-163.79-62.48-226.28 0l90.51 45.25v18.75c0 16.97 6.74 33.25 18.75 45.25l49.14 49.14c16.71 16.71 40.3 21.98 61.61 16.35l28.9 28.9-11.31 11.31c-6.25 6.25-6.25 16.38 0 22.63l22.63 22.63c6.25 6.25 16.38 6.25 22.63 0l90.51-90.51c6.23-6.24 6.23-16.37-.02-22.62zm-286.72-15.2c-3.7-3.7-6.84-7.79-9.85-11.95L19.64 404.96c-25.57 23.88-26.26 64.19-1.53 88.93s65.05 24.05 88.93-1.53l238.13-255.07c-3.96-2.91-7.9-5.87-11.44-9.41l-49.14-49.14z",
    fill: color2
  }
) });
const getColorStyles$1 = (color2) => {
  return colorStyles[color2] || {
    color: "#d1d2d3",
    bgGradient: `linear(to-b,#FFF, #333)`
  };
};
const TeamComponent$1 = ({
  teamLetter,
  teamName,
  teamColor,
  teamStyles,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { w: "full", bg: Background, bgGradient: teamStyles.bgGradient, h: "50px", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Text,
      {
        ...
        ml: "10px",
        alignContent: "center",
        children: teamName || `Team ${teamLetter}`
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Flex,
      {
        ...
        children: hammerState === teamLetter ? /* @__PURE__ */ jsxRuntimeExports.jsx(HammerIcon, { h: "36px", w: "32px", color: teamColor !== "yellow" ? "white" : "black" }) : null
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Text,
...
function VerticalScoreboard({
  ...
  const teamAStyles = getColorStyles$1(teamAColor);
  const teamBStyles = getColorStyles$1(teamBColor);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { bg: "transparent", h: "auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { w: "100%", justify: "center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      VStack,
      {
        fontSize: "3xl",
        ...
        p: "2px",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { justify: "center", w: "full", h: "30px", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { justify: "space-between", w: "full", h: "full", bg: "#fff", alignContent: "center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Text,
              {
                textAlign: "left",
                ...
                textOverflow: "ellipsis",
                ml: "10px",
                children: spielGameType || "Round Robin"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Text,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Flex,
      {
        ...
        p: "2px",
        pb: 0,
        children: teamBRockCountState !== 0 || teamARockCountState !== 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          VStack,
          {
            gap: "0px",
            w: "auto",
            ...
            justify: "left",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { bg: "d1d2d3", w: "full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                TeamARocks,
                {
                  hammerState,
                  teamBRockCountState,
...
function BoxScore({
  ...
  const getColorStyles2 = (color2) => {
    return colorStyles[color2] || {
      color: "#d1d2d3",
      bgGradient: `linear(135deg,#333,#FFF, #333)`
    };
  };
  const teamAStyles = getColorStyles2(teamAColor);
  const teamBStyles = getColorStyles2(teamBColor);
  const height = "30px";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { padding: "2px", fontSize: "xl", bg: "black", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(VStack, { color: "black", w: "200px", align: "left", justify: "center", gap: 0, spacing: 0, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Box,
        {
          h: height,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Box,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Text,
            {
              textShadow: teamAColor !== "yellow" ? "1px 1px 2px rgba(0, 0, 0, 0.8)" : "1px 1px 2px rgba(255, 255, 255, 0.8)",
              textAlign: "left",
              fontSize: "lg",
              color: teamAStyles.color,
              whiteSpace: "nowrap",
              ...
              mx: "10px",
              alignContent: "center",
              children: teamAName || "Team A"
            }
          )
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { h: "1px", bg: "black" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Box,
        {
          h: height,
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Text,
            {
              textShadow: teamBColor !== "yellow" ? "1px 1px 2px rgba(0, 0, 0, 0.8)" : "1px 1px 2px rgba(255, 255, 255, 0.8)",
              textAlign: "left",
              fontSize: "lg",
              color: teamBStyles.color,
              whiteSpace: "nowrap",
    ...
    teamScores.map((scores, index) => {
      if (index === 8 && scores.score1 === "X" && scores.score2 === "X" || index === 9 && scores.score1 === "X" && scores.score2 === "X") {
        return null;
      }
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(VStack, { w: "30px", justify: "center", gap: 0, spacing: 0, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Box,
          {
            h: height,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Box,
          {
            ...
            textAlign: "center",
            alignContent: "center",
            children: end <= index + 1 && scores.score1 !== "X" && scores.score1 <= 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: end === index + 1 && hammerState === "A" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { justify: "center", align: "center", p: "2px", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HammerIcon, { h: "25px", w: "20px", color: "black" }) }) : null }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              Text,
              {
                w: "full",
                h: "full",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Box,
          {
            ...
            textAlign: "center",
            alignContent: "center",
            children: end <= index + 1 && scores.score2 !== "X" && scores.score2 <= 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: end === index + 1 && hammerState === "B" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { justify: "center", align: "center", p: "2px", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HammerIcon, { h: "25px", w: "20px", color: "Black" }) }) : null }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              Text,
              {
                w: "full",
                h: "full",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(VStack, { w: "60px", justify: "center", gap: 0, spacing: 0, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Box,
        {
          h: height,
...
function VertScoreNoRocks({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { bg: "transparent", h: "auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { w: "100%", justify: "center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    VStack,
    {
      fontSize: "3xl",
      color: "#fefefe",
      ...
      p: "2px",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { justify: "center", w: "full", h: "30px", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { justify: "space-between", w: "full", h: "full", bg: "#fff", alignContent: "center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Text,
          {
            textAlign: "left",
            w: "full",
...
function App() {
  ...
  const [vertScoreType, setVertScoreType] = reactExports.useState("1");
  ...
  const [teamScores, setTeamScores] = reactExports.useState([
    { score1: 0, score2: 0 },
    { score1: 0, score2: 0 },
    { score1: 0, score2: 0 },
    { score1: 0, score2: 0 },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { minH: "100vh", bg: "#00ff00", justifyContent: "center", fontFamily: "sans-serif", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { color: "white", p: 2, w: "full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(HStack, { spacing: 50, children: vertScoreType === "1" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      VerticalScoreboard,
      {
        teamAName,
        teamAScore,
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(ChakraProvider, { theme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) })
);
